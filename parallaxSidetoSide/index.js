! function e(t, i, r) {
  ...
  1: [function(e) {
      e("../libs/jquery.mousewheel.js"), e("../libs/jquery.custom.js"), e("../util/customEventEngine.js"), e("../layout/parallax.js"), e("../layout/resizeables.js"), e("../ui/preloader.js"), e("../pages/index.js"), e("../pages/indexNav.js")
  }, {
      "../layout/parallax.js": 2,
      "../layout/resizeables.js": 3,
      "../libs/jquery.custom.js": 4,
      "../libs/jquery.mousewheel.js": 5,
      "../pages/index.js": 6,
      "../pages/indexNav.js": 7,
      "../ui/preloader.js": 8,
      "../util/customEventEngine.js": 9
  }],
  2: [function() {
      window.parallax = function(e) {
          function t(e, t) {
              ...
              return L == S.CSS3_EASED && v(T, this.$src), this.applyWindowSize = function() {
                  if (i) {
                      hotdot.applyHorizontalShift("", e), e.css({
                          width: ""
                      });
                  ...
                  e.css({
                      ...
                      overflow: "visible",
                      position: "absolute"
                  }), this.left = "auto" == h ? n - o : parseInt(h, 10), T !== E.LEFT && this.$src.css("left", "0px"), s = 0 == this.spd ? r - o : this.spd > 0 && this.spd < 1 ? (r - o) * (1 - this.spd) + this.left * this.spd : this.left
              }, this.parallaxLeft = function(e) {
                  return this.currentLeft = 0 == this.spd ? s + e : this.spd > 0 && this.spd < 1 ? s + e * d : s - e * c, this.currentLeft
          ...
          function i(i, r, n) {
              ...
              this.childrenVisible = !0, this.adjust = function() {
                  ...
                  var t = this.left + this.width,
                      i = this.left < 0 && 0 > t,
                      r = this.left > s && t > s;
                  if (!i && !r || e.noSlideHideOptimization) {
                      this.childrenVisible || (o.show(), this.childrenVisible = !0);
                      for (var n = -this.left, a = 0, l = this.layers[0], d = this.layers.length; d > a; a++, l = this.layers[a]) l.adjust(n)
                  } else this.childrenVisible && (o.hide(), this.childrenVisible = !1)
              };
              var a = this;
              return this.applyWindowSize = function() {
                  s = z, this.$src.css("display", ""), r ? (this.width = this.prnt.width, this.initialLeft = 0) : (this.width = z, this.initialLeft = this.prnt.width, this.$src.css("width", this.width))
              }, this.applyWindowSize(), this.applyWindowSizeToChildren = function() {
                  o.show();
                  for (var e = 0, t = a.layers.length; t > e; e++) a.layers[e].applyWindowSize()
              }, this.initChildren = function() {
                  var e;
                  e = r ? this.$src.children("[data-speed]") : $("*[data-speed]", this.$src), o.show(), e.each(function() {
                      var e = $(this);
                      if ("1" == e.attr("data-speed")) e.css({
                          position: "absolute"
                      }), a.$axis = e;
                      else {
                          var i = new t(e, a);
          ...
          function r() {
              M.$src = $("#" + m), M.$src.scroll = 0, y ? $("html").css("overflow", "hidden") : $("html").css({
                  "overflow-x": "scroll",
                  "overflow-y": "hidden"
              }), M.$src.children("div").css({
                  height: "100%",
                  position: "relative",
                  "float": "left",
                  overflow: "hidden"
                  ...
                  "overflow-x": "visible",
                  position: "fixed"
              }), C === S.CSS3_EASED && v(I, M.$src), n(), s(), o(), h(), $("." + b).css("z-index", "auto"), this.onInit()
          }
          function n() {
          ...
          function a() {
              P = (k.cur - M.$src.scroll) / 15, Math.abs(P) > k.minimalStep ? (M.$src.scroll += P, u()) : k.doingNextMove && (k.doingNextMove = !1, void 0 !== customEventEngine && customEventEngine.call(D, "finishedMove", M.$src.scroll), M.$src.removeClass("disable-hover"))
          }
          function l() {
              M.$src.scroll = k.cur, u(), W = !1
          }
          function d() {
              if (F = k.cur / M.singleSlideWidth, "onBorder" == N) {
                  for (; R - .5 >= F;) para.currentSlideI--, R = para.currentSlideI;
                  for (; F >= R + .5;) para.currentSlideI++, R = para.currentSlideI
              } else {
                  for (; R - 1 >= F;) para.currentSlideI--, R = para.currentSlideI;
                  for (; F >= R + 1;) para.currentSlideI++, R = para.currentSlideI
              }
          }
          function c() {
              k.cur = k.get(), k.delta = Math.abs(M.$src.scroll - k.cur), k.doingNextMove = !0, void 0 !== customEventEngine && customEventEngine.call(D, "startedMove", M.$src.scroll), W || M.$src.addClass("disable-hover"), W ? l() : x == S.EASED ? j || (j = setInterval(a, 17)) : x == S.SUPER_EASED ? k.delta > 70 ? (k.firstStep = !0, M.$src.stop(!0, !0).animate({
                  scroll: k.cur
              }, {
                  step: function(e, t) {
                      return k.firstStep ? (t.start = M.$src.scroll, void(k.firstStep = !1)) : (u(), void(M.$src.scroll = e))
                  },
                  duration: A,
                  easing: _
              })) : (M.$src.stop(!0, !0), M.$src.scroll = k.cur, u()) : x == S.JQ_EASED ? M.$src.stop().animate({
                  scroll: k.cur
              }, {
                  step: function(e) {
                      M.$src.scroll = e, u()
          ...
          function u() {
              h(), void 0 !== customEventEngine && customEventEngine.call(D, "scrollChange", M.$src.scroll)
          }
          function h() {
              C == S.CSS3_EASED || C == S.NONE ? hotdot.applyHorizontalShift(-M.$src.scroll, M.$src, I) : C == S.JQ_EASED && g(M.$src, -M.$src.scroll);
              for (var e = 0, t = M.array[0], i = M.array.length; i > e; e++, t = M.array[e]) t.adjust()
          }
          function f() {
              var t = k.$src ? !1 : !0;
              if (t ? startWindowWidth = z : k.$src.remove(), e.touchNotScrollMode) {
                  ...
                  t && (M.$src[0].addEventListener("touchmove", function(e) {
                      if (!(e.touches.length > 1)) {
                          e.preventDefault(), time.end = (new Date).getTime(); {
                              time.end - time.start
                          }
                          n = e.touches[0].screenX - r, s.cur = n * n / 15 * (0 > n ? -1 : 1), k.add(-s.cur), r = e.touches[0].screenX, time.start = time.end
                      }
                  }), M.$src[0].addEventListener("touchstart", function(e) {
                      time.start = (new Date).getTime(), r = e.touches[0].screenX, k.stop()
                  }));
                  var o = M.width - z,
                      a = 0;
                  k.add = function(e) {
                      k.cur + e > o ? k.cur = o : k.cur + e < a ? k.cur = a : k.cur += e, c()
                  }, k.stop = function() {
                      k.cur = M.$src.scroll
                  }, k.get = function() {
                      return k.cur
                  ...
                  y || (k.$src = $("<div/>").css({
                      width: M.width,
                      height: "1px"
                  }), $("body").append(k.$src), l = window), k.get = function() {
                      return y ? k.cur : $(l).scrollLeft()
                  }, k.add = function(e) {
                      if (y) {
                          var t = k.cur + e;
                          return 0 > t ? t = 0 : t > k.maxLimit && (t = k.maxLimit), k.cur = t, void c()
                      }
          ...
          function v(e, t) {
              ...
              e == E.LEFT ? transi = "left " + i : (e == E.TRANSLATE || e == E.TRANSLATEX || e == E.TRANSLATE3D) && (transi = "-webkit-transform " + i), t.css({
          ...
          var j, P, W = !1,
              R = 0,
              F = 0;
          this.toSlide = function(e) {
              e > -1 && e < M.array.length && this.to(z * e)
          }, this.to = function(e) {
              k.add(e - k.get())
  ...
  3: [function() {
      window.resizeables = {
          engineCreator: void 0,
          engine: void 0,
          initFromDescript: function(e) {
              resizeables.engine.getContainersFromDescript(e)
          },
          init: function() {
          ...
          function t(e) {
              function t() {
                  u = windowAspect > f ? n.orientations.LANDSCAPE : n.orientations.PORTRAIT
              }
              ...
              this.recollectMetrics = function() {
                  l.css({
                      ...
                      w: i.w / resizeables.reference.w,
                      h: i.h / resizeables.reference.h
                  }, o = parseInt(l.css("font-size"), 10)
              }, a = e.versionB, a && l.css("display", "inline-block"), this.recollectMetrics(), criticalElements = l.find("." + n.criticalReadabilityClass), this.parent = l.parent();
              var u, h = "none",
                  f = 1;
          ...
          return this.findContainers = function() {
              ...
              for (var e = 0, t = r[e]; i > e; e++, t = r[e]) t.adjust()
          }, this
      ...
      jQuery.effects || function(e, t) {
          ...
          e.effects = {
              ...
              function(t, i) {
                  function r(e, t, i) {
                      var r = h[t.type] || {};
                      return null == e ? i || !t.def ? null : t.def : (e = r.floor ? ~~e : parseFloat(e), isNaN(e) ? t.def : r.mod ? (e + r.mod) % r.mod : 0 > e ? 0 : r.max < e ? r.max : e)
                  }
                  function n(e) {
                      var i = c(),
                          r = i._rgba = [];
                  ...
                  var o, a = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "),
                      ...
                      c = t.Color = function(e, i, r, n) {
                          return new t.Color.fn.parse(e, i, r, n)
                      },
                      u = {
                          rgba: {
                              props: {
                      ...
                      p = t("<p>")[0],
                      v = t.each;
                  p.style.cssText = "background-color:rgba(1,1,1,.5)", f.rgba = p.style.backgroundColor.indexOf("rgba") > -1, v(u, function(e, t) {
                      ...
                      parse: function(s, a, l, d) {
                          ...
                          var h = this,
                              f = t.type(s),
                              p = this._rgba = [];
                          return a !== i && (s = [s, a, l, d], f = "array"), "string" === f ? this.parse(n(s) || o._default) : "array" === f ? (v(u.rgba.props, function(e, t) {
                              p[t.idx] = r(s[t.idx], t)
                          }), this) : "object" === f ? (s instanceof c ? v(u, function(e, t) {
                      ...
                      is: function(e) {
                          ...
                          return v(u, function(e, n) {
                              var s, o = t[n.cache];
                              return o && (s = r[n.cache] || n.to && n.to(r._rgba) || [], v(n.props, function(e, t) {
                                  return null != o[t.idx] ? i = o[t.idx] === s[t.idx] : void 0
                              })), i
                          }), i
                      },
                      _space: function() {
                      ...
                      toHexString: function(e) {
                          var i = this._rgba.slice(),
                              r = i.pop();
                          return e && i.push(~~(255 * r)), "#" + t.map(i, function(e) {
                      ...
                      expand: function(e) {
                          var t = {};
                          return v(["Top", "Right", "Bottom", "Left"], function(i, r) {
                              t["border" + r + "Color"] = e
                          }), t
                      }
                  }, o = t.Color.names = {
              ...
              function() {
                  ...
                  function r(t, i) {
                      var r, n, o = {};
                      for (r in i) n = i[r], t[r] !== n && (s[r] || (e.fx.step[r] || !isNaN(parseFloat(n))) && (o[r] = n));
                      return o
                  }
                  ...
                  e.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, i) {
                      ...
                      return this.queue(function() {
                          ...
                          d = d.map(function() {
                              ...
                              return this.end = i.call(this.el[0]), this.diff = r(this.start, this.end), this
                          }), o.attr("class", a), d = d.map(function() {
                              var t = this,
                                  i = e.Deferred(),
                                  r = jQuery.extend({}, l, {
                                      queue: !1,
                      ...
                      addClass: function(t, i, r, n) {
                          return i ? e.effects.animateClass.call(this, {
                              add: t
                          }, i, r, n) : this._addClass(t)
                      },
                      _removeClass: e.fn.removeClass,
                      removeClass: function(t, i, r, n) {
                          return i ? e.effects.animateClass.call(this, {
                              remove: t
                          }, i, r, n) : this._removeClass(t)
                      },
                      _toggleClass: e.fn.toggleClass,
                      toggleClass: function(i, r, n, s, o) {
                          return "boolean" == typeof r || r === t ? n ? e.effects.animateClass.call(this, r ? {
                              add: i
                          } : {
                              remove: i
                          }, n, s, o) : this._toggleClass(i, r) : e.effects.animateClass.call(this, {
                              toggle: i
                          }, r, n, s)
                      },
                      switchClass: function(t, i, r, n, s) {
              ...
              function() {
                  function n(t, i, r, n) {
                      return e.isPlainObject(t) && (i = t, t = t.effect), t = {
                          effect: t
                      }, null == i && (i = {}), e.isFunction(i) && (n = i, r = null, i = {}), ("number" == typeof i || e.fx.speeds[i]) && (n = r, r = i, i = {}), e.isFunction(r) && (n = r, r = null), i && e.extend(t, i), r = r || i.duration, t.duration = e.fx.off ? 0 : "number" == typeof r ? r : r in e.fx.speeds ? e.fx.speeds[r] : e.fx.speeds._default, t.complete = n || i.complete, t
                  }
                  function s(t) {
                  ...
                  e.extend(e.effects, {
                      version: "1.9.1",
                      save: function(e, t) {
                          for (var i = 0; i < t.length; i++) null !== t[i] && e.data(r + t[i], e[0].style[t[i]])
                      },
                      restore: function(e, i) {
                          var n, s;
                          for (s = 0; s < i.length; s++) null !== i[s] && (n = e.data(r + i[s]), n === t && (n = ""), e.css(i[s], n))
                      },
                      ...
                      effect: function() {
                          ...
                          return e.fx.off || !a && !l ? s ? this[s](r.duration, r.complete) : this.each(function() {
                              r.complete && r.complete.call(this)
                          }) : a ? o === !1 ? this.each(t) : this.queue(o || "fx", t) : l.call(this, {
                              options: r,
                              duration: r.duration,
                              callback: r.complete,
                              mode: r.mode
  ...
  6: [function() {
      function e() {
          function e() {
              Modernizr.history && $("a").on("click", function() {
                  var e = $(this).attr("href");
                  "" != e && "#" != e && window.history.pushState({
                      mediaIsLoaded: "true"
                  }, "mediaIsLoaded")
              }), tdLib.debLog("in preloader.onLoad"), resizeables.initFromDescript(o), r(), parallax && para.init(), t(), $("#parallax").trigger("preloadFinish")
          }
          ...
          Modernizr.csstransforms3d && (n.layerShiftProperty = "translate3d", n.parallaxShiftProperty = "translate3d"), para = new parallax(n), tdLib.debLog("afterPara"), void 0 !== window.resizeables && (resizeables.baseFontSize = parseInt($("body").css("font-size"))), para.onInit = function() {
              tdLib.debLog("para.onInit"), para.mouseWheelTarget.bind("mousewheel", s), $(window).on("resize", i), preloader.disable(), f.applyHashFromAddressLine(), tdLib.debLog("no fix")
          }, customEventEngine.bind(para, "scrollChange", function() {
              f.trackHashChange()
          }), customEventEngine.bind(para, "startedMove", function() {
              !hotdot.settings.pauseSideAnimationsWhenMoving
          }), hotdot.preloaderEnabled ? preloader.onLoad = e : (preloader.init(), e(), setTimeout(function() {
              i()
          }, 300)), hotdot.preloaderEnabled && preloader.start(), tdLib.debLog("at the end of main routine")
      }
      function t() {
      ...
      function i() {
          para.onResizeSlides(), r(), para.onResizeLayers(), t()
      }
      function r() {
          d = $(window).innerWidth(), c = $(window).innerHeight(), l = d / c, h = n(d), adjustFontSize(), resizeables.adjust()
      }
      function n(e) {
          var t = hotdot.settings.mousewheelSlowness.windows;
          return tdLib.deviceDescription.os == tdLib.OS_TYPES.mac && (t = hotdot.settings.mousewheelSlowness.mac), e / t
      }
      function s(e, t) {
          return para.stopParallax ? !1 : (para.add(-t * h), e.preventDefault(), void e.stopPropagation())
      }
      var o = [{
          srcString: "video",
      ...
      window.para = {};
      var a, l, d, c, u, h;
      hotdot.animateOnlyHDLogo = !1, hotdot.preloaderEnabled = !0, hotdot.settings = {
          isWindowsSafari: tdLib.deviceDescription.type == tdLib.DEVICE_TYPES.desktop && tdLib.deviceDescription.os != tdLib.OS_TYPES.mac && tdLib.deviceDescription.browser == tdLib.BROWSERS.safari,
          disableAutoHashChange: tdLib.deviceDescription.type == tdLib.DEVICE_TYPES.android,
          removeScrollbar: tdLib.deviceDescription.type != tdLib.DEVICE_TYPES.wPhone,
          touchNotScrollMode: tdLib.deviceDescription.type != tdLib.DEVICE_TYPES.desktop && tdLib.deviceDescription.touchCapable,
          showTouchHint: tdLib.deviceDescription.type != tdLib.DEVICE_TYPES.desktop && (supportsTouchEvents || tdLib.deviceDescription.touchCapable),
          isAppleMobileDevice: tdLib.deviceDescription.type == tdLib.DEVICE_TYPES.iPad || tdLib.deviceDescription.type == tdLib.DEVICE_TYPES.iPhone,
          mousewheelSlowness: {
              windows: 15,
              mac: 60
          },
          pauseSideAnimationsWhenMoving: !0
      }, hotdot.settings.logoNavigationAdvancedRendering = Modernizr.csstransforms3d && !hotdot.settings.isWindowsSafari, document.ontouchmove = function(e) {
          e.preventDefault()
      }, $(document).keydown(function(e) {
          return "37" == e.keyCode || "39" == e.keyCode || "32" == e.keyCode ? para.stopParallax ? !1 : void("37" == e.keyCode ? (para.closerLeft(), e.preventDefault()) : ("39" == e.keyCode || "32" == e.keyCode) && (para.closerRight(), e.preventDefault())) : void 0
      });
      var f = {
      ...
      $(window).on("hashchange", function(e) {
          return e.preventDefault(), f.doNotApplyHashFromAddressLine ? void(f.doNotApplyHashFromAddressLine = !1) : (f.applyHashFromAddressLine(), !1)
      }), $(e)
  }, {}],
  7: [function() {
      window.onload = function() {
          ...
          function t(e) {
              ...
              i = setTimeout(function() {
                  para.currentSlideI == para.slidesCount - 1 ? $(".left-arrow").fadeIn(1e3) : 0 == para.currentSlideI ? ($(".right-arrow").fadeIn(1e3), r && ("#" == n || n) && $(".nav-animation").fadeIn(1e3)) : $(".left-arrow, .right-arrow").fadeIn(1e3), r = !1
              }, e)
          }
          var i, r = !0;
          setTimeout(function() {
              customEventEngine.bind(para, "finishedMove", function() {
                  t(2e3)
              }), customEventEngine.bind(para, "startedMove", function() {
                  clearTimeout(i), $(".left-arrow, .right-arrow, .nav-animation").css("display", "none")
              }), t(5e3), $(".left-arrow").click(para.closerLeft), $(".right-arrow").click(para.closerRight)
          }, 2e3), $(".left-arrow, .right-arrow, .nav-animation").addClass(e() ? "touch" : "no-touch")
      }
  }, {}],
  8: [function() {
      window.preloader = {
      ...
      preloader.fillVisuals = function(e, t) {
          t || (t = function() {}), preloader.visuals.loaded.animate({
              width: preloader.targetLogoWidth * e
          }, {
              duration: preloader.fillingTime,
              queue: !1
          }), preloader.visuals.unloaded.animate({
              width: (1 - e) * preloader.targetLogoWidth
          }, {
              duration: preloader.fillingTime,
              queue: !1,
              complete: t
          })
      }, preloader.disable = function(t) {
          t && t.rough ? ($("." + e).remove(), preloader.$slide.remove()) : ($("." + e).delay(300).animate({
              opacity: 0
          ...
          preloader.visuals = {
              loaded: $(".Preload-end"),
              unloaded: $(".Preload-start")
          }, preloader.$slide = $(".Preloader"), preloader.targetLogoWidth = .9 * $(window).innerWidth()
      }, preloader.start = function() {
          function e() {
              var e = r.filter(function() {
                  return this.src && this.src.indexOf("svg") > -1 ? !1 : void 0 !== this.readyState && this.readyState >= 3 ? !1 : this.complete ? !1 : !0
              });
              return e.length
          }
          function t() {
              var t = e();
              return 0 == t ? (tdLib.debLog("No need to load."), preloader.onLoad(), void preloader.disable({
                  rough: !1
  ...
  9: [function() {
      ! function(e) {
          e.customEventEngine = {
              init: function(e, t) {
                  e.cUE || (e.cUE = {}), e.cUE[t] || (e.cUE[t] = [])
              },
              call: function(t, i, r) {
                  t.cUE && t.cUE[i] || e.customEventEngine.init(t, i);
                  for (var n in t.cUE[i]) t.cUE[i][n](r)
              },
              bind: function(t, i, r) {
                  t.cUE && t.cUE[i] || e.customEventEngine.init(t, i), t.cUE[i].push(r)
              }
          }
      }(window)
  }, {}]
